...
namespace ACE_it.Data.Migrations
{
    ...
    [Migration("20190407015833_AddUserRecipes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACE_it.Models.RecipeIngredient", b =>
                {
                    b.Property<int>("RecipeId");
            ...
            modelBuilder.Entity("ACE_it.Models.UserCompletedRecipe", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("ACE_it.Models.UserFavouriteIngredient", b =>
                {
                    b.Property<string>("UserId");
                    ...
                    b.ToTable("UserFavouriteIngredient");
                });

            modelBuilder.Entity("ACE_it.Models.UserFavouriteRecipe", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("ACE_it.Models.UserUnwantedIngredient", b =>
                {
                    b.Property<string>("UserId");
                    ...
                    b.ToTable("UserUnwantedIngredient");
                });
            ...
            modelBuilder.Entity("ACE_it.Models.RecipeIngredient", b =>
                {
                    b.HasOne("ACE_it.Models.Ingredient", "Ingredient")
            ...
            modelBuilder.Entity("ACE_it.Models.UserFavouriteIngredient", b =>
                {
                    b.HasOne("ACE_it.Models.Ingredient", "Ingredient")
                        .WithMany("UserFavouriteIngredients")
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ACE_it.Models.UserUnwantedIngredient", b =>
                {
                    b.HasOne("ACE_it.Models.Ingredient", "Ingredient")
                        .WithMany("UserUnwantedIngredients")
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("ACE_it.Models.UserWillPrepareRecipe", b =>
                {
                    b.HasOne("ACE_it.Models.Recipe", "Recipe")
                        .WithMany("UserWillPrepareRecipes")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade);
